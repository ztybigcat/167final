...
void PointCloud::updatePointSizeL()
{
	/*
...
void PointCloud::updatePointSizeS()
{
    /*
     * TODO: Section 3: Implement this function to adjust the point size.
     */
...
void PointCloud::updateModelSize(double offset)
{
    model = offset>0 ? glm::scale(model, glm::vec3(1.03f, 1.03f, 1.03f)) : glm::scale(model, glm::vec3(0.97f, 0.97f, 0.97f));
}
